...
def readargs():
    ...
    parser.add_argument('--accuracy', default=40, type=int, help="threshold for displaying names")
    parser.add_argument('--full_screen', default=False, type=bool, help="Display in full screen")
